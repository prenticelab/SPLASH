...
For example, assuming the current value of $\tilde{\omega} = 283^{\circ}$, then $t(360 - \tilde{\omega}) = 76.2$ days. 
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$I_N$}{Net radiation flux, W$\cdot$m$^{-2}$}
\begin{equation}
\label{eq:rn}
	I_N = I_{SW} - I_{LW}
\end{equation}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$I_{SW}$}{Net shortwave solar radiation flux, W$\cdot$m$^{-2}$}
\begin{equation}
\label{eq:rns}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$I_{S\downarrow}$}{Incident shortwave solar radiation flux, W$\cdot$m$^{-2}$}
\begin{equation}
\label{eq:rs}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$I_{LW}$}{Net longwave radiation flux, W$\cdot$m$^{-2}$}
\begin{equation}
\label{eq:rnl}
	\begin{split}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$I_{L\uparrow}$}{Longwave upward radiation flux, W$\cdot$m$^{-2}$}
\begin{equation}
\label{eq:rlu}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$I_{L\downarrow}$}{Longwave clear-sky downward radiation flux, W$\cdot$m$^{-2}$}
\begin{equation}
\label{eq:rld}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$H_N$}{Daily daytime net radiation, J$\cdot$m$^{-2}$}
\begin{equation}
\label{eq:dayrn}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$H_N^{\ast}$}{Daily nighttime net radiation, J$\cdot$m$^{-2}$}
\begin{equation}
\label{eq:dayrnn}
	\begin{split}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$Q_n$}{Daily photosynthetic photon flux density, mol$\cdot$m$^{-2}$}
\begin{equation}
\label{eq:dayppfd}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$L_v$}{Latent heat of vaporization of water, J$\cdot$kg$^{-1}$}
\begin{equation}
\label{eq:latent}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$E^q$}{Equilibrium evapotranspiration rate, mm$\cdot$h$^{-1}$}
\begin{equation}
\label{eq:eet}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$E^p$}{Potential evapotranspiration rate, mm$\cdot$h$^{-1}$}
\begin{equation}
\label{eq:pet}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$D_p$}{Evaporative demand rate, mm$\cdot$h$^{-1}$}
\begin{equation}
\label{eq:dp}
...
%% ------------------------------------------------------------------------ %%
\nomenclature{$E^a$}{Actual evapotranspiration rate, mm$\cdot$h$^{-1}$}
\begin{equation}
\label{eq:aet}
